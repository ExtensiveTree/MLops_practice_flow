...
with DAG(
    ...
    get_data = BashOperator(task_id='get_data',
                            bash_command="python3 /home/akashy/staidg/scripts/get_data.py", 
                            dag=dag)
    process_data = BashOperator(task_id='process_data',
                            bash_command="python3 /home/akashy/staidg/scripts/process_data.py", 
                            dag=dag)
    train_test_split_data = BashOperator(task_id='train_test_split_data',
                            bash_command="python3 /home/akashy/staidg/scripts/train_test_split.py", 
                            dag=dag)  
    train_model = BashOperator(task_id='train_model',
                            bash_command="python3 /home/akashy/staidg/scripts/train_model.py", 
                            dag=dag)
    test_model = BashOperator(task_id='test_model',
                            bash_command="python3 /home/akashy/staidg/scripts/test_model.py", 
                            dag=dag)
